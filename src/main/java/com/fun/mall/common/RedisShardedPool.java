...
public class RedisShardedPool {
    ...
    private static String ip1=PropertiesUtil.getProperty("redis1.host");
    private static Integer port1=Integer.parseInt(PropertiesUtil.getProperty("redis1.port","6379"));
    private static String pass1=PropertiesUtil.getProperty("redis1.pass");
    private static Integer timeout1=Integer.parseInt(PropertiesUtil.getProperty("redis1.timeout","2000"));

    private static String ip2=PropertiesUtil.getProperty("redis2.host");
    private static Integer port2=Integer.parseInt(PropertiesUtil.getProperty("redis2.port","6380"));
    private static String pass2=PropertiesUtil.getProperty("redis2.pass");
    private static Integer timeout2=Integer.parseInt(PropertiesUtil.getProperty("redis2.timeout","2000"));
