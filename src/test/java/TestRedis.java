...
/**
 * @ Author     ：CZP.
 * @ Date       ：Created in 17:41 2018/12/1
...
public class TestRedis {
    ...
    public void testString(){
        ...
        // 设置多个键值对
        jedis.mset("name", "czp", "age", "20", "tel", "18520987632");
        jedis.incr("age"); // 加1操作
        System.out.println(jedis.get("name") + "-" + jedis.get("age") + "-" + jedis.get("tel"));
    }
    /**
     * redis操作map集合
     */
